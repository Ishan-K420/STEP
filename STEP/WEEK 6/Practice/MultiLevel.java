public class MultiLevel {
    ...
    static class Dog extends Mammal {
        ...
        public Dog() {
            super("Canine", "Domestic", 13, false, "Brown", 60);
            this.breed = "Mixed";
    ...
    public static void main(String[] args) {
        System.out.println("=== Constructor Chain: Basic Dog ===");
        Dog dog1 = new Dog();
        ...
        System.out.println("\n=== Constructor Chain: Detailed Dog ===");
        Dog dog2 = new Dog("Canine", "Urban", 12, true, "Black", 65,
                           "Labrador", true, 9, "Swimming");
        dog2.demonstrateInheritance();

        System.out.println("\n=== Constructor Chain: Copy Dog ===");
