public class GameController {
    ...
    public void calibrateController() {
        System.out.println("Starting " + controllerBrand + " controller...");
    }
    ...
    public void testVibration() {
        if (hasVibration)
            System.out.println("Vibration test successful!");
        else
            System.out.println("Vibration disabled.");
    }

    public static void main(String[] args) {
        System.out.println("=== GAMING CONTROLLER SETUP ===");

        GameController c1 = new GameController(); // default
        GameController c2 = new GameController("Xbox", "Wireless", true, 80, 2.0);
