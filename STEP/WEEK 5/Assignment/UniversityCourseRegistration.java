...
// Immutable AcademicRecord class
...
// Student class with educational privacy
class Student {
    private final String studentId;
    ...
    public Student(String studentId, String name, String major, AcademicRecord undergraduateRecord) {
        ...
        this.academicRecord = new AcademicRecord(studentId, major, LocalDate.now(), 
                                               ...
                                               undergraduateRecord.getCumulativeGPA(), null);
    }
...
// Registration System with access control
...
public class UniversityCourseRegistration {
    public static void main(String[] args) {
        ...
        // Create student with completed courses
        Map<String, String> completedCourses = new HashMap<>();
        completedCourses.put("CS101", "A");
        Student student = new Student("S001", completedCourses, 3.8);
        student.setEmail("student@university.edu");
        
        // Create professor
        Professor prof = new Professor("P001", "Computer Science", List.of("PhD", "Industry Experience"));
